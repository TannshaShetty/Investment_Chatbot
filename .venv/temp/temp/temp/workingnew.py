...
def parse_invoice_data(delimited_data):
    try:
        ...
        headers = ["Total Amount", "Base Amount", "Tax Amount", "Recipient Name", "Sender Name", "Invoice Date", "Invoice Number","Tax Rate"]
...
def app():
    ...
    if uploaded_file is not None:
        ...
        try:
            ...
            total_amount,base_amount,tax_amount,recipient_name,sender_name,invoice_date,invoice_number,tax_rate
            Reply only with the values, separated by commas.
            PUT NA IF MISSING VALUES.
            HANDLE INVOICES OF DIFFERENT LANGUAGE AND CONVERT THEM AND CONVERT THEM INTO ENGLISH IN THE GIVEN STRUCTURED CSV FORMAT"""
